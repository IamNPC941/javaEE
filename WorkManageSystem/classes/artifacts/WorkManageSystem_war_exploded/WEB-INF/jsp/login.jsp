	...
	<body>
		<div class="page-container">
            ...
            <form id="login" action="login" method="get">
                <input style="background-color: #98FB98" type="text" name="account" class="account" placeholder="请输入您的账号！">
                <input style="background-color: #98FB98" type="password" name="password" class="password" placeholder="请输入您的用户密码！"><br><br>
                <strong>类型：</strong>
